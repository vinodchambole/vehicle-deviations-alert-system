...
2) ViolationController
   ...
   3) notifyViolations: This captures the vehicle number standing in signal and checks violations and then notifies traffic police about violations and associated fine with it.
3) GovtController
